...
namespace WinFormsApp1
{
    public partial class Form1 : Form, IUserInfo
    {
        ...
        string IUserInfo.PlaceOfResidence { get => this.placeOfResidenceTextBox.Text; set => this.placeOfResidenceTextBox.Text = value; }
        string IUserInfo.Gender { get => this.genderTextBox.Text; set => this.genderTextBox.Text = value; }
